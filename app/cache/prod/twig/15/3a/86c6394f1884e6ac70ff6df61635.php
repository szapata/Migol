...
class __TwigTemplate_153a86c6394f1884e6ac70ff6df61635 extends Twig_Template
{
    protected $parent;
...
";
    ...
    public function block_firstCol($context, array $blocks = array())
    {
        ...
        echo "</h3>
                <p><em>";
        // line 18
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("public.signin.start.enjoy"), "html");
        echo "</em></p>
            ";
    }
...
";
    ...
    {
        return "MigolCommonPagesBundle::3colsLayout.html.twig";
    }
